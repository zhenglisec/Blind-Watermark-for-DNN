...
from models import SSIM, LeNet1
...
parser.add_argument('--wm_num', nargs='+', default=[500, 600],  # 1% of train dataset
...
if args.wm_train:
    for wm_idx, (wm_input, wm_cover_label) in enumerate(trigger_loader):
        ...
        if args.dataset == 'cifar10' and wm_idx == (int(args.wm_num[0]/args.wm_batchsize)-1):  # 训练集 1% 的部分作触发集
            break
